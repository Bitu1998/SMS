using SMS.Core.Security.Constant;

namespace SMS.Core.Security.HeaderPolicy
{
    /// <summary>
    ...
    public class SecurityHeadersBuilder
    {
        ...
        {
            _policy.SetHeaders[ContentSecurityPolicyConstant.Header] = ContentSecurityPolicyConstant.defaultsrc;

            return this;
        }
        public SecurityHeadersBuilder AddAccessControlAllowOrigin()
        {
            _policy.SetHeaders[AccessControlAllowOriginConstant.Header] = AccessControlAllowOriginConstant.defaultsrc;
            return this;
        }
